...
import { FaQuoteLeft, FaTree, FaSun, FaHistory, FaBookOpen, FaPray, FaInfoCircle, FaStar, FaAward, FaCircleNotch } from "react-icons/fa";
...
export default function AboutPage() {
  ...
  // Elegant loader matching the premium aesthetic
  if (loading) {
    return (
      <div className="min-h-screen bg-sacred-white flex flex-col justify-center items-center font-sans">
        <motion.div 
          animate={{ rotate: 360 }}
        ...
        <p className="text-gray-500 font-extrabold uppercase tracking-widest text-xs animate-pulse">
          {lang === "en" ? "Connecting to Siddh Peeth..." : "सिद्ध पीठ से जुड़ रहे हैं..."}
        </p>
      </div>
    );
  }
