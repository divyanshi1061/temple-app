        ...
        <div className="space-y-10 md:space-y-14">
          ...
          >
            ...
            <div className="text-sm md:text-base text-gray-700 leading-relaxed font-medium space-y-3">
              <p>
                {lang === "en"
                  ? "**Summary: Situated on the Lakhundar River, Nalkheda Dham is an ancient Siddh Peeth where Lord Krishna guided the Pandavas to perform victory sadhana.** Our temple stands on the sacred banks of the Lakhundar River (ancient Lakshmana River) in Madhya Pradesh, carrying an aura that has drawn seekers for millennia. As documented in ancient chronicles, this sanctum is unique because the Tri-Shakti—Maa Baglamukhi, Maa Lakshmi, and Maa Saraswati—are worshiped together in their self-manifested forms. It is here that the Pandavas sat in silent meditation before the battle of Kurukshetra, seeking the strength to overcome their formidable adversaries."
                  : "**सारांश: लखुंदर नदी के तट पर स्थित नलखेड़ा धाम वह ऐतिहासिक भूमि है जहाँ भगवान श्रीकृष्ण ने पांडवों को विजय प्राप्ति के लिए साधना का निर्देश दिया था।** यह पावन मंदिर मध्य प्रदेश के नलखेड़ा में प्रवाहित पवित्र लखुंदर नदी (प्राचीन लक्ष्मणा नदी) के तट पर स्थित है, जो हजारों वर्षों से साधकों के लिए श्रद्धा का केंद्र रहा है। शास्त्रों के अनुसार, इस सिद्ध पीठ में त्रि-शक्ति—माँ बगलामुखी, माँ लक्ष्मी और माँ सरस्वती एक ही वेदी पर विराजमान हैं। महाभारत युद्ध से पूर्व, विषम परिस्थितियों में पांडवों ने इसी स्थान पर अनुष्ठान कर विजयश्री का आशीर्वाद प्राप्त किया था।"}
              </p>
              <p>
                {lang === "en"
