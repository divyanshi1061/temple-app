            ...
            <div className="text-sm md:text-base text-gray-700 leading-relaxed font-medium space-y-3">
              <p>
                {lang === "en"
                  ...
                  : "**सारांश: नलखेड़ा धाम लखुंदर नदी के तट पर स्थित एक प्राचीन सिद्ध पीठ है, जहाँ भगवान श्रीकृष्ण ने पांडवों को महाभारत युद्ध में विजय के लिए बगलामुखी साधना करने का निर्देश दिया था।** नलखेड़ा, आगर मालवा, मध्य प्रदेश में स्थित सिद्ध पीठ माँ बगलामुखी मंदिर भारत के सबसे प्राचीन और आध्यात्मिक रूप से शक्तिशाली देवी मंदिरों में से एक है। यह पवित्र लखुंदर नदी (प्राचीन लक्ष्मणा नदी) के पावन तट पर स्थित है। *कालिका पुराण* के अनुसार, यहाँ त्रि-शक्ति—माँ बगलामुखी, माँ लक्ष्मी और माँ सरस्वती पिंडी रूप में विराजमान हैं। द्वापर युग में जब पांडवों पर बड़ा संकट आया, तब स्वयं भगवान श्रीकृष्ण ने उन्हें यहाँ विजय साधना करने का मार्गदर्शन दिया था।"}
              </p>
              <p>
                {lang === "en"
