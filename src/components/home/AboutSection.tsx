    ...
    const fetchAbout = async () => {
      try {
        ...
        if (res.ok) {
          ...
          if (data && (data.titleEn || data.titleHi)) {
            setAbout(data);
          }
        }
      } catch (error) {
